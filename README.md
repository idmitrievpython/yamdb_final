...
[![API for YaMDB project workflow](https://github.com/idmitrievpython/yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg)](https://github.com/idmitrievpython/yamdb_final/actions/workflows/yamdb_workflow.yml)
...
```bash
git clone https://github.com/idmitrievpython/infra_sp2
```
